...
if [ "$AURA_EXECUTED" = 0 ]; then
  ...
  source "$(dirname "${BASH_SOURCE[0]}")/install_env.sh"
  return 0
fi
...
download_file scripts/install_env.sh scripts/install_env.sh
download_file scripts/appliance_posture.sh scripts/appliance_posture.sh
