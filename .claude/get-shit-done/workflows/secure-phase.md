...
```
Agent(
  prompt="Read /home/user/Aura/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/Aura/.claude/get-shit-done/templates/SECURITY.md`
