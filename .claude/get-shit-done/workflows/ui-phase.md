...
```markdown
Read /home/user/Aura/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/Aura/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/Aura/.claude/agents/gsd-ui-checker.md for instructions.
