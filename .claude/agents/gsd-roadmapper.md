...
Reference full template: `/home/user/Aura/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/Aura/.claude/get-shit-done/templates/state.md`.
