...
<required_reading>
@/home/user/Aura/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/home/user/Aura/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/Aura/.claude
                  → checks /home/user/Aura/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/Aura/.claude/get-shit-done
                  → writes to /home/user/Aura/.claude/get-shit-done/hooks/
...
@/home/user/Aura/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/user/Aura/.claude/get-shit-done/references/common-bug-patterns.md
