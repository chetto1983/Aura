...
<reference>
@/home/user/Aura/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/Aura/.claude/get-shit-done/references/user-profiling.md` to load:
