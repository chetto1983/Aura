...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/Aura/.claude/.gsd-surface.json`
(sibling to `/home/user/Aura/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/Aura/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/Aura/.claude/skills`).
...
`/home/user/Aura/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/Aura/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/Aura/.claude/.gsd-surface.json`
Install profile marker: `/home/user/Aura/.claude/.gsd-profile`
Skill dirs: `/home/user/Aura/.claude/skills/gsd-*/`
Engine module: `/home/user/Aura/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/home/user/Aura/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
