...
// `value` and `defaultValue` ride the spread rather than being named: under
// exactOptionalPropertyTypes an explicit `value={value}` would widen the prop to
// number[] | undefined, which Radix does not accept.
function Slider({
  className,
  min = 0,
  max = 100,
