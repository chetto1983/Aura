...
import { LayoutDashboard, BookText, Network, Inbox, Calendar, Bot, Sparkles, Plug, ShieldCheck, MessagesSquare, FileCheck, Wrench, Archive, Settings as SettingsIcon, Sun, Moon, Contrast, LogOut } from 'lucide-react';
