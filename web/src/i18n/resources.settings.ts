export const settingsEn = {
  settings: {
    ...
    models: {
      ...
      refresh: 'Refresh',
      references_one: 'up to {{count}} reference image',
...
export const settingsIt = {
  settings: {
    ...
    models: {
      ...
      refresh: 'Aggiorna',
      references_one: 'fino a {{count}} immagine di riferimento',
    ...
    fields: {
      ...
      imageModel: 'Modello per generare immagini',
      videoModel: 'Modello per generare video',
