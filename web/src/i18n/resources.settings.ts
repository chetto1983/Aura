export const settingsEn = {
  settings: {
    ...
    models: {
      ...
      useLocalSidecar: 'Use local sidecar',
      useLocalSidecarDescription: 'Clear the cloud model and use the configured local service',
      refresh: 'Refresh',
    ...
    embedding: {
      ...
      body: 'Choose the route that produces embeddings. The local sidecar address is never used for cloud models.',
      label: 'Embedding backend route',
      local: 'Local',
    ...
    fields: {
      ...
      ttsCloudVoice: 'Text-to-speech cloud voice',
...
export const settingsIt = {
  settings: {
    ...
    models: {
      ...
      useLocalSidecar: 'Usa il sidecar locale',
      useLocalSidecarDescription: 'Rimuovi il modello cloud e usa il servizio locale configurato',
      refresh: 'Aggiorna',
    ...
    embedding: {
      heading: 'Backend embedding',
      body: 'Scegli il percorso che produce gli embedding. L’indirizzo del sidecar locale non viene mai usato dai modelli cloud.',
      label: 'Percorso backend embedding',
      local: 'Locale',
      openrouter: 'OpenRouter',
    ...
    fields: {
      ...
      ttsCloudVoice: 'Voce cloud text-to-speech',
