...
export const mediaEditEn = {
  mediaEdit: {
    ...
    picker: {
      action: 'Open Garage library',
      title: 'Choose from Garage',
      description: 'Open an image or video already stored in your library.',
    ...
    photo: {
      ...
      studioUnreachable: 'The Studio did not answer. Try again.',
    ...
    video: {
      ...
      emptyExport: 'The export produced an empty file.',
...
export const mediaEditIt = {
  mediaEdit: {
    ...
    picker: {
      action: 'Apri libreria Garage',
      title: 'Scegli dalla libreria Garage',
      description: 'Apri un’immagine o un video già presente nella tua libreria.',
    ...
    photo: {
      ...
      studioUnreachable: 'Lo Studio non ha risposto. Riprova.',
    ...
    video: {
      ...
      emptyExport: "L'esportazione ha prodotto un file vuoto.",
