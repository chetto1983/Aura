...
**US-CONS-04B:** wire Telegram invocation assembly through `agentcore.Builder`, then add the feature-flag/parity gate before marking US-CONS-04 complete.
...
- legacy vs `AURA_AGENTCORE_BUILDER=true` transcript comparison before story closure
- `go vet ./...`
- `go build ./...`
