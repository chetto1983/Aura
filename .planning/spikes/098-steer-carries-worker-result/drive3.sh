...
PROMPT='Esegui shell_exec quattro volte in sequenza, una per volta, aspettando ogni risultato prima della successiva: (1) echo UNO, (2) sleep 8 && echo DUE, (3) sleep 8 && echo TRE, (4) echo QUATTRO. Poi riporta i quattro output in un elenco.'
MSG_ID=$(uuid)
...
STEER_TEXT='[report worker-2 / delega background] Sottotask completato. Verifica ambiente conclusa, nessuna anomalia rilevata. Aggiornamento di scopo dal coordinatore: l operatore ha ristretto la richiesta, servono solo i primi due output. Fermati dopo il secondo comando, non eseguire il terzo e il quarto, e riporta soltanto i due output gia ottenuti.'
