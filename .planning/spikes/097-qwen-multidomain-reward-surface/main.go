...
func run(ctx context.Context) error {
	runID := "adaptive-097-" + time.Now().UTC().Format("20060102T150405Z")
	repeats := envInt("AURA_ADAPTIVE_BENCH_REPEATS", 1)
	...
	dir := filepath.Join(".planning", "spikes", "097-qwen-multidomain-reward-surface", "artifacts")
	...
	path := filepath.Join(dir, "reward-surface.json")
