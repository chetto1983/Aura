...
- [x] 28-06-PLAN.md — Onboarding frontend: full-screen wizard (credentials → capability picker → Telegram link+QR → interview → review+Create)
...
| 30. Retrieval & Memory Pipeline Hardening (Rerank + Full-Docs E2E) | v1.0.0 | 2/5 | In Progress|  |
