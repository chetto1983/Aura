...
- [ ] 08.2-01-PLAN.md — `internal/semindex` reusable core: pure math (cosine/centroid/margin) + Classifier (Centroid) + Ranker (PerItem) wrappers + unit tests [Req-1, Req-8, D-01]
