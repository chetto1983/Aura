...
- [ ] 06-05-PLAN.md — scripts/cache_invariant_audit.sh wrapper + SC#5 negative test + Postgres-free CI gate wiring (amendment #16, wave 5)
...
| 6. KV Cache Builder | 3/5 | In Progress|  |
