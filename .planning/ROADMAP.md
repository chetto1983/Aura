...
- [x] **Phase 37: Per-User Full-Capability Sandbox** — `SBX-01..05` (F-001 sandbox, F-036) (executed; 37-10 closed the SBX-04 composition-root BLOCKER; all 5 SC mechanism-verified + test-2 docker_integration `-race` suite LIVE-PASS on WSL 2026-07-07; **operator force-close 2026-07-08** accepting the 4 native-Linux/32GB/runsc live tiers as sanctioned WSL/CI Gate-3 deferrals — tracked in 37-UAT.md + 37-VALIDATION.md as REL-03 must-runs before the honest 10/10 release) (completed 2026-07-08)
