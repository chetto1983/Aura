...
- [ ] **Phase 37: Per-User Full-Capability Sandbox** — `SBX-01..05` (F-001 sandbox, F-036) (executed; 37-10 closed the SBX-04 composition-root BLOCKER; re-verified **human_needed** 2026-07-07 — all 5 SC mechanism-verified, final Gate-3 close awaits the WSL/CI live tiers via `/gsd-verify-work 37`)
