...
- [ ] **LOOP-01**: A terminal `text_response` is mutually exclusive with mutating/runnable sibling tools — such a model step is rejected or replanned before any sibling executes. *(F-003)*
