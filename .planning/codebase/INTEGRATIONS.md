...
- `calendar` → Aura PIM sidecar (`ghcr.io/chetto1983/aura-pim-mcp:4e0f518333773a892f9f5a718981466e6054ae2e`, forked calendar-mcp 1.4.1 @ `aura/pim-sidecar`), unified mail+calendar+contacts, streamable-HTTP
