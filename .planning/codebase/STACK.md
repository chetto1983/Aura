...
- Pinned images: `postgres:18.4-alpine3.24`, `arcadedata/arcadedb:26.9.1` (digest-pinned; ≥26.4.2 enforced by `VerifySecureVersion` for CVE-2026-44221), `dxflrs/garage:v2.3.0`, `tecnativa/docker-socket-proxy:v0.5.0`, `searxng/searxng:2026.7.26`, `prom/prometheus:v3.13.1`, `grafana/tempo:2.9.4`, `grafana/grafana:12.3.9`.
