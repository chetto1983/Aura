...
| 07-01-T3 | 01 | 1 | CAP-05 | T-07-03 | Missing `SEARXNG_URL` is NOT boot-fatal (fail-closed at call time); web config + goleak harness build | unit | `go build ./... && go test ./internal/web/... && grep -E "AURA_WEB_DNS_PIN_TTL_SEC\|AURA_WEB_FETCH_MAX_BODY_BYTES\|SEARXNG_URL" .env.example` | ✅ | ✅ green |
