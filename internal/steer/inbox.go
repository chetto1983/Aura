...
// SourceMedia is the reserved source for a detached video job's terminal runtime fact.
// It follows SourceShell's rules: generated by Aura, delivered in the untrusted tool-output
