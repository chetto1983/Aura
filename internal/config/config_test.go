...
func clearPostgresEnv(t *testing.T) {
	...
	keys := []string{
		...
		"AURA_EMBED_BASE_URL", "AURA_EMBED_DIMENSIONS", "AURA_EMBED_REVISION", "AURA_EMBED_FINGERPRINT",
		...
		"AURA_SETUP_BIND", "AURA_SETUP_TOKEN",
		"MULTIMODAL_BASE_URL", "MULTIMODAL_MODEL",
