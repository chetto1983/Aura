...
func knobRegistry() []KnobSpec {
	return []KnobSpec{
		...
		{Name: "AURA_DOCLING_BASE_URL", Kind: KindString, Default: "http://127.0.0.1:5001"},
		{Name: "AURA_DOCLING_API_KEY", Kind: KindString, Default: "", Secret: true},
		{Name: "AURA_DOCLING_IMAGE", Kind: KindString, Default: DoclingImageV1290},
