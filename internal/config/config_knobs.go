...
func knobRegistry() []KnobSpec {
	return []KnobSpec{
		...
		// malformed value is FLAGGED (not silently absorbed) under a strict tier, matching
		// AURA_AGUI_CORS_PERMISSIVE's registration shape.
		...
		{Name: "AURA_AGUI_RUN_DETACH", Kind: KindBool, Default: "false"},
		...
		{Name: "AURA_LEARNING_SEEN_MAX_ENTRIES", Kind: KindInt, Default: "100000"},
		{Name: "AURA_LEARNING_SEEN_TTL_DAYS", Kind: KindInt, Default: "30"},
		{Name: "AURA_LEARNING_EXAMPLE_TTL_DAYS", Kind: KindInt, Default: "90"},
		{Name: "AURA_LEARNING_BUCKET_CAP", Kind: KindInt, Default: "512"},
		{Name: "AURA_LEARNING_STORE_CAP", Kind: KindInt, Default: "10000"},
