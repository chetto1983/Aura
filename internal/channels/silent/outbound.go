...
// NewHeartbeat returns an Outbound bound to chat.ChannelHeartbeat.
func NewHeartbeat(cfg Config) *Outbound {
	return build(chat.ChannelHeartbeat, cfg)
}

// NewCron returns an Outbound bound to chat.ChannelCron.
...
// Channel satisfies chat.OutboundAdapter.
func (o *Outbound) Channel() chat.Channel { return o.channel }

// Mode is always DeliveryModeSilent.
func (*Outbound) Mode() chat.DeliveryMode { return chat.DeliveryModeSilent }
