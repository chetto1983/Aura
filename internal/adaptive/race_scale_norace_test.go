...
// about production. It bit in the Memory MCP job, where `-race` runs alongside Neo4j, the
// embedding sidecar and the Python memory server on the same 2-vCPU runner: a 32,768-outcome
