...
var settingsCatalog = []SettingItem{
	...
	{Key: settings.KeySkillPreflight, Value: config.DefaultSkillPreflight, Group: "agent", Kind: "enum", Options: []string{"advisory", "required", "off"}, Label: "Skill preflight", Hint: "advisory suggests useful skills without blocking tool work"},
