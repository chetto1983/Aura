...
var settingsCatalog = []SettingItem{
	...
	{Key: settings.KeyWorkspaceRoot, Value: config.DefaultWorkspaceRoot, Group: "agent", Kind: "text", Label: "Workspace root", Hint: "Default is the process workspace; containers set /app. Restart Aura after changing."},
