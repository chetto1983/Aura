...
type AuraAdaptiveFocalCohortClaims struct {
	...
	InterferenceClusterSchemaSha256 []byte             `json:"interference_cluster_schema_sha256"`
	InterferenceClusterID           []byte             `json:"interference_cluster_id"`
}
...
type AuraAdaptiveRandomizationReceipts struct {
	ID                          pgtype.UUID        `json:"id"`
	OwnerID                     pgtype.UUID        `json:"owner_id"`
	CohortID                    pgtype.UUID        `json:"cohort_id"`
	RequestID                   pgtype.UUID        `json:"request_id"`
