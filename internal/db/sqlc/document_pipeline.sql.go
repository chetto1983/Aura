...
WITH locked_document AS MATERIALIZED (
    ...
    SELECT $6, slot.identity_id, slot.document_id, $4,
           slot.version_number, $7, $8, $3,
           $9, $10, $5,
           $11, $12,
