...
export const it: Record<keyof typeof en, string> = {
  ...
  remoteIdentityFile: 'Percorso della chiave privata SSH (vuoto per lasciar decidere a ssh)',
  remoteIdentityChoose: 'Chiave SSH per autenticarsi (evita una password per connessione)',
  remoteIdentityOther: 'Un altro percorso...',
  remoteIdentityNone: 'Nessuna chiave - ssh chiedera la password a ogni connessione',
  ...
  unreadableIdentityFile: 'Chiave SSH non leggibile. Indica il percorso di una chiave privata esistente, oppure lascia vuoto.',
