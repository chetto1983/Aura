...
func buildOnboardingService(ctx context.Context, chat *chatEnv, authulaProvider *webauth.Provider) agui.OnboardingService {
	...
	// documents-plane leak that no longer exists; it was deleted rather than corrected,
	// since the refusal is the enforcing control and advisory only ever restated it.
