...
func TestProductionContainerArtifactsMatchFatImageContract(t *testing.T) {
	...
	for _, want := range []string{
		...
		"AURA_OBJECTSTORE_ACCESS_KEY: ${AURA_OBJECTSTORE_ACCESS_KEY:-garage}",
		"AURA_OBJECTSTORE_SECRET_KEY: ${AURA_OBJECTSTORE_SECRET_KEY:-garage-secret}",
		...
		"GARAGE_RPC_SECRET: ${GARAGE_RPC_SECRET:-aura-dev-garage-rpc-secret}",
