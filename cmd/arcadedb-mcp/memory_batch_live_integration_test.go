...
func TestAgentMemoryMCPLive_BatchAtomicity(t *testing.T) {
	...
	hits, err := alphaClient.FactsAbout(ctx, "PublishedBatch", "likes", 10, time.Time{}, arcadedb.FactsAboutDirect)
...
func agentMemoryBatchStateHash(
	...
	t.Helper()
	hits, err := client.FactsAbout(ctx, subject, "", 100, time.Time{}, arcadedb.FactsAboutDirect)
	if err != nil {
