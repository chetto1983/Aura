...
| **Phase-MODERNIZE** | Infrastructure hygiene + Wave-1 god-file splits (user 2026-05-22 option B: "Phase-INFRA + Wave 1 god-files"). 5 INFRA stories — depguard v2 enforcing §9 forbidden deps + golang.org/x/tools/cmd/deadcode in CI + 600-LOC file-size linter with grandfather baseline + opt-in lefthook pre-commit + auto-generated MODULE-HEALTH.md scoreboard. 10 god-file splits — migrations.go 1562, memoryindex/store.go 1143, runs/store.go 812, api/types.go 771, wiki/memory_hygiene.go 751, api/auth/store.go 740, sources/ingest/pipeline.go 733, qdrant.go 725, search.go 653, cron/dispatch.go 643. Plan + Ralph queue: `.planning/post-drift-2026-05-21/Phase-MODERNIZE/plan.md` + `scripts/ralph/prd-phase-modernize-staged.json` | ~3 sessions, 15 atomic stories | +540 (infra) + 0 (splits rebalance) | 🔴 **NEXT** — kicks after Phase-BUG closure |
