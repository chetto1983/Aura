...
> - **WEBVOICE-03** — cloud-only: TTS/STT run on OpenRouter with no local sidecar; when the cloud models are unconfigured the UI degrades gracefully (speaker hidden / mic in attachment mode) with no errors.
