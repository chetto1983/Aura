...
| **Phase-OUT** | Output discipline (truncate / spill / repeated-lookup throttle / tasks_completed / length-recovery / orphan-backfill) + 3 NEW budget enforcement stories (US-OUT-07 per-tool-class budget caps, US-OUT-08 OR-of-four guard, US-OUT-09 force-finalize on cap). Backed by 2 convergent scouts 2026-05-22 on tool-budget patterns (Hermes/nanobot/openhuman + arXiv 2511.17006). User-locked NEXT after Phase-MODERNIZE. | ~3 sessions, 9 atomic stories | ~+720 | 🟣 staged — locked next after Phase-MODERNIZE |
